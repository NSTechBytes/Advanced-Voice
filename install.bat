...
set "zipFile=Advanced Voice.zip"
set "extractPath=Advanced Voice"
...
start "" "%cd%\Advanced Voice\instructions.html"

REM Notify the user
echo The ZIP file has been extracted. Please follow the instructions in the opened HTML file to install the Advanced Voice.
